...
function endpointBodyTemplate(path) {
  ...
  return html` <style>
    ...
    <div
      ...
      class="endpoint-body ${path.method} ${path.deprecated
        ? 'deprecated'
        : ''}"
    >
      <div class="summary">
        ...
        <div class="mono-font regular-font-size label-operation-container">
          ...
          >
            <span class="regular-font upper method-fg bold-text ${path.method}"
              >${path.method}</span
            >
          </div>
          <div class="label-operation-path-container">
            <content-copy-button
              ...
              content="${joinURLandPath(this.selectedServer.url, path.path)}"
            ></content-copy-button>
          </div>
        </div>
        ${path.description
          ? html`<div
              part="section-endpoint-body-description"
