...
export default function overviewTemplate() {
  this.resolvedSpec.info.description = processPathDescription(
      ...
      ${this.resolvedSpec?.info
        ? html`
            ${this.specUrl && this.allowSpecFileDownload === 'true'
              ? html` <div
                  style="display:flex; margin-top:18px; gap:8px; justify-content: flex-end; flex-wrap: wrap;"
                >
                  <button
                    class="m-btn thin-border m-btn-tertiary"
            ...
            >
              ...
              ${!this.resolvedSpec.info.version
                ? ''
                : html` <code> ${this.resolvedSpec.info.version} </code>`}
            </div>
            <div
              id="api-info"
