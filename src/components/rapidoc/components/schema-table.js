    ...
    return html`
      ...
      >
        ...
        ${this.data?.['::description']
          ? html`<span part="schema-description" class="m-markdown">
              ${unsafeHTML(marked(this.data['::description'] || ''))}</span
            >`
          : ''}
        <div class="param-table">
          <div
            style="display:flex; border-bottom:1px solid var(--light-border-color);"
          >
            <div
              class="key"
              style="font-family:var(--font-regular); font-weight:bold; color:var(--fg); padding: 10px 14px;"
            >
              Field
            </div>
            <div
        ...
        ${newSchemaLevel >= 0 && key
          ? html` <div
            ...
            >
              ...
              <div class="td key-descr" style="line-height:1.7">
...
customElements.get('schema-table') ||
